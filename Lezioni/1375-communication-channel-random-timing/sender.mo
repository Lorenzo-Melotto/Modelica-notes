block Sender
	...
	//parameter Real T = 1000; // time in milliseconds
  ...
  /*
		...
		markov chain with time in seconds
		T = 1, S = 10, thus p = 1 - 1/10 = 9/10
		Transition Matrix MC

		markov chain with time in milliseconds (does not change)
		T = 1000, S = 10000, thus p = 1 - 1000/10000 = 9/10

		la catena non cambia, ma abbiamo 1000 occasioni in più per fare la send
  */
